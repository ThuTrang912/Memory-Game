...
public class EasyActivity extends AppCompatActivity implements View.OnTouchListener , View.OnClickListener{
    public static final String SHARED_PREFERENCE_NAME = "EasyActivityContinue";
    private int SIZE = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HighScoreActivity.easyHighScore = 0;
        ...
        MainActivity.previousClass = "EasyActivity";
        for(int i = 0 ; i < SIZE ; i++) {
...
//            intent.putExtra("continueStatusId",rdIdQs);
...
//            tvScore.setText("SCORE : " + score + "        " + "STEP LEFT : " + (MAX_STEP - count));
    ...
    public void isWin(){
        if(score == SIZE*5 && count <= MAX_STEP ){
            ...
            HighScoreActivity.easyHighScore = score;
        }else {
